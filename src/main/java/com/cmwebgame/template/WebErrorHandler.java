...
public class WebErrorHandler extends ConsoleErrorHandler
{
	...
	protected void render(Writer w, String title, String msg)
	{
		try
		{
			msg = "鲜Q网正在休整升级中......<br>我们将给你带来更大的惊喜！</br><br> 鲜Q，thank you ！</br>";
			w.write(DEV_MODEL_ERROR.replace("[title]", msg).replace("[message]", title));
		}
		catch (IOException e)
		{
		}
