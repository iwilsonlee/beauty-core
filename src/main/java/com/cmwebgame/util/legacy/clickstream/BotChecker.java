package com.cmwebgame.util.legacy.clickstream;
...
import com.cmwebgame.util.legacy.clickstream.config.ClickstreamConfig;
import com.cmwebgame.util.legacy.clickstream.config.ConfigLoader;
 ...
 * @author Rafael Steil (little hacks for CMWEBGAME)
